...
Write **[Unreleased]** bullets at the same level as the released sections below. One user-visible outcome per bullet, a few sentences at most: what changed and why it matters. Combine related work into one bullet. Leave out implementation edge cases, internal invariants, and step-by-step behavior. Keep this note here; do not copy it into a released section.
